...
GLOBAL.SERVER.DEV = 'https://www.linkedin-ei.com/'
...
GLOBAL.SERVER.SFDC = GLOBAL.IS_PROD_ADDIN ? GLOBAL.SERVER.SFDC_PROD : GLOBAL.SERVER.SFDC_DEV;
GLOBAL.SERVER.APP = GLOBAL.IS_PROD_ADDIN ? GLOBAL.SERVER.PROD : GLOBAL.SERVER.DEV;
GLOBAL.SERVER.UI  = GLOBAL.SERVER.APP + 'sales/';

GLOBAL.BUNDLE.JS  = GLOBAL.SERVER.UI + 'assets/%2Flighthouse-frontend%2Fjavascripts%2Fintegrations%2FSN4X%2Fcompiled%2Fbundle.min.js';
GLOBAL.BUNDLE.CSS = GLOBAL.SERVER.UI + 'assets/%2Flighthouse-frontend%2Fconcat%2Flfg-plugin' + (GLOBAL.IS_PROD_ADDIN ? '-prod' : '') + '_en_US.css';
GLOBAL.DEPENDENCIES = [
  GLOBAL.SERVER.APP + "sales/assets/%2Flighthouse-frontend%2Fconcat%2Flfg-profile-view_en_US.css",
  GLOBAL.SERVER.APP + "sales/assets/%2Flighthouse-frontend%2Fconcat%2Flfg-tasks_en_US.css",
  GLOBAL.SERVER.APP + "sales/assets/%2Flighthouse-frontend%2Fconcat%2Flfg-common_en_US.css",
  GLOBAL.BUNDLE.CSS,
  GLOBAL.BUNDLE.JS,
