...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:ms="urn:microsoft-performance" exclude-result-prefixes="msxsl" version="1.0">
	...
	<xsl:variable name="images">
		...
		<!-- root cause states -->
		<String id="fixed">Corrigé</String>
		<String id="notfixed">Non réparé</String>
		<String id="detected">Détecté</String>
		<!-- details -->
		<String id="info">Informatif</String>
		<String id="warning">Avertissement</String>
		<String id="error">Erreur</String>
		<!-- expand and print buttons -->
		<String id="expand">Développer</String>
		<String id="print">Imprimer</String>
	</xsl:variable>
...
function key_folder(d, state)
{
  if (window.event.keyCode == 13) {
    ...
    event.returnValue = false;
						...
						<div class="page">
							<xsl:variable name="strings">
								<String id="Found">Problèmes trouvés</String>
								<String id="Checked">Problèmes potentiels qui ont été vérifiés</String>
								<String id="Publisher">Détails de l’éditeur</String>
								<String id="Detection">Détails de la détection</String>
	...
	<xsl:template name="RootCauseStatus">
		<xsl:variable name="strings">
			<String id="Fixed">Corrigé</String>
			<String id="Not Detected">Problème non présent</String>
			<String id="Not Fixed">Non corrigé</String>
			<String id="Detected">Détecté</String>
		</xsl:variable>
		<div>
			<xsl:if test="Data[@id='Status'] = 'Not Detected'">
	...
	<xsl:template name="RootCauseEmpty">
		<xsl:variable name="strings">
			<String id="Empty">Aucun problème détecté</String>
		</xsl:variable>
	...
	<xsl:template name="ResolutionStatus">
		<xsl:variable name="strings">
			<String id="Not Run">Non exécuté</String>
			<String id="Succeeded">Terminé</String>
			<String id="Failed">Échec</String>
			<String id="Informational">Informationnel</String>
			<String id="Status">Statut</String>
		</xsl:variable>
		<div class="italic">
			<xsl:call-template name="label">
				<xsl:with-param name="strings" select="$strings"/>
	...
	<xsl:template name="ScriptStatus">
		<xsl:variable name="strings">
			<String id="Succeeded">Opération réussie</String>
			<String id="Failed">Échec</String>
		</xsl:variable>
		<xsl:choose>
	...
	<xsl:template match="InputArguments[Data]|OutputArguments[Data[@id !='Result']]">
		<xsl:variable name="strings">
			<String id="InputArguments">Arguments d’entrée</String>
			<String id="OutputArguments">Arguments de sortie</String>
		</xsl:variable>
	...
	<xsl:template match="Object[@Type='System.Diagnostics.Eventing.Reader.EventLogRecord']">
		<xsl:variable name="strings">
			<String id="LevelDisplayName">Niveau</String>
			<String id="LogName">Journal </String>
	...
	<xsl:template match="ComputerInformation">
		<xsl:variable name="strings">
			<String id="Computer">Nom de l’ordinateur</String>
			<String id="Collection">Informations sur la collecte des données</String>
		</xsl:variable>
